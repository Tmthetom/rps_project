...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'LBarInit'
;------------------------------------------------------------
;i                         Allocated to registers r2 
;------------------------------------------------------------
	G$LBarInit$0$0 ==.
	C$ledbar.c$13$0$0 ==.
;	ledbar.c:13: void LBarInit(void)
;	-----------------------------------------
;	 function LBarInit
;	-----------------------------------------
_LBarInit:
...
;	ledbar.c:29: LB_OE=0;
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'LedBar'
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$LedBar$0$0 ==.
	C$ledbar.c$33$1$1 ==.
;	ledbar.c:33: void LedBar(word val)
;	-----------------------------------------
;	 function LedBar
;	-----------------------------------------
_LedBar:
