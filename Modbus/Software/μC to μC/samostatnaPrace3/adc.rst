   ...
   0000                     676 	.ds 8
                            ...
                            743 ;------------------------------------------------------------
                            744 ;adconf                    Allocated to registers 
                            745 ;------------------------------------------------------------
                    0000    746 	G$AdcInit$0$0 ==.
                    0000    747 	C$adc.c$5$0$0 ==.
                            748 ;	adc.c:5: void AdcInit(byte adconf)
                            749 ;	-----------------------------------------
   ...
   0134                     752 _AdcInit:
                    ...
                    0000    759 	ar0 = 0x00
                    0001    760 	ar1 = 0x01
   0134 85 82 F6            761 	mov	_ADCF,dpl
                    0003    762 	C$adc.c$8$1$1 ==.
                            763 ;	adc.c:8: ADCLK=0x08;
   0137 75 F2 08            764 	mov	_ADCLK,#0x08
                    0006    765 	C$adc.c$9$1$1 ==.
                            766 ;	adc.c:9: ADCON = MSK_ADCON_ADEN;
   013A 75 F3 20            767 	mov	_ADCON,#0x20
   ...
   013D 22                  770 	ret
                    ...
                    000A    777 	C$adc.c$12$1$1 ==.
                            ...
                            781 ;	-----------------------------------------
   013E                     782 _AdcConv:
   013E AA 82               783 	mov	r2,dpl
                    000C    784 	C$adc.c$14$1$1 ==.
                            785 ;	adc.c:14: ADCON &= ~MSK_ADCON_SCH;
   0140 53 F3 F8            786 	anl	_ADCON,#0xF8
                    000F    787 	C$adc.c$15$1$1 ==.
                            788 ;	adc.c:15: ADCON |= (channel & MSK_ADCON_SCH);
   0143 74 07               789 	mov	a,#0x07
   0145 5A                  790 	anl	a,r2
   0146 42 F3               791 	orl	_ADCON,a
                    0014    792 	C$adc.c$16$1$1 ==.
                            793 ;	adc.c:16: ADCON |= MSK_ADCON_ADSST;                   /* Start prevodu */
   0148 43 F3 08            794 	orl	_ADCON,#0x08
                    0017    795 	C$adc.c$17$1$1 ==.
                            796 ;	adc.c:17: while((ADCON & MSK_ADCON_ADEOC)==0);
   014B                     797 00101$:
   014B E5 F3               798 	mov	a,_ADCON
   014D 30 E4 FB            799 	jnb	acc.4,00101$
                    001C    800 	C$adc.c$18$1$1 ==.
                            801 ;	adc.c:18: ADCON &= ~MSK_ADCON_ADEOC;
   0150 53 F3 EF            802 	anl	_ADCON,#0xEF
                    001F    803 	C$adc.c$19$1$1 ==.
                            804 ;	adc.c:19: return (ADDH <<2)+(ADDL & 3);
   0153 AA F5               805 	mov	r2,_ADDH
   0155 E4                  806 	clr	a
   0156 CA                  807 	xch	a,r2
   0157 25 E0               808 	add	a,acc
   0159 CA                  809 	xch	a,r2
   015A 33                  810 	rlc	a
   015B CA                  811 	xch	a,r2
   015C 25 E0               812 	add	a,acc
   015E CA                  813 	xch	a,r2
   015F 33                  814 	rlc	a
   0160 FB                  815 	mov	r3,a
   0161 74 03               816 	mov	a,#0x03
   0163 55 F4               817 	anl	a,_ADDL
   0165 FC                  818 	mov	r4,a
   0166 7D 00               819 	mov	r5,#0x00
   0168 EC                  820 	mov	a,r4
   0169 2A                  821 	add	a,r2
   016A F5 82               822 	mov	dpl,a
   016C ED                  823 	mov	a,r5
   016D 3B                  824 	addc	a,r3
   016E F5 83               825 	mov	dph,a
