...
F:G$ComInit$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$VarInit$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$SendBuf$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$main$0$0({2}DF,SV:S),C,0,0,0,0,0
S:G$cnt_ticks$0$0({1}SC:U),E,0,0
S:G$adr_r$0$0({1}SC:U),E,0,0
S:G$bity$0$0({1}DA1,SC:U),E,0,0
S:G$val$0$0({2}SI:U),E,0,0
S:G$flagMessage$0$0({2}SI:S),E,0,0
S:G$index$0$0({2}SI:S),E,0,0
S:G$itx$0$0({2}SI:S),E,0,0
S:G$readedByte$0$0({1}SC:S),E,0,0
S:G$registerCode$0$0({1}SC:S),E,0,0
S:G$pocet$0$0({1}SC:S),E,0,0
S:G$errorCode$0$0({1}SC:S),E,0,0
S:G$lrc$0$0({1}SC:U),E,0,0
S:G$readedRegister$0$0({2}SI:U),E,0,0
S:G$bufferIn$0$0({256}DA256,SC:U),F,0,0
S:G$bufferOut$0$0({256}DA256,SC:U),F,0,0
...
S:G$WrWord$0$0({2}DF,SC:U),C,0,0
S:G$RdWord$0$0({2}DF,SI:U),C,0,0
S:G$MrtuRdCrc$0$0({2}DF,SI:U),C,0,0
S:G$MrtuCrc$0$0({2}DF,SI:U),C,0,0
S:G$MrtuWrCrc$0$0({2}DF,SC:U),C,0,0
S:G$MrtuWrOne$0$0({2}DF,SC:U),C,0,0
S:G$MrtuWr$0$0({2}DF,SC:U),C,0,0
S:G$MrtuRd$0$0({2}DF,SC:U),C,0,0
S:G$MrtuAnsErr$0$0({2}DF,SC:U),C,0,0
S:G$MrtuAnsRd$0$0({2}DF,SC:U),C,0,0
S:G$AHex$0$0({2}DF,SC:U),C,0,0
S:G$HexAsc$0$0({2}DF,SC:U),C,0,0
S:G$MbRdByte$0$0({2}DF,SC:U),C,0,0
S:G$MbRdWord$0$0({2}DF,SI:U),C,0,0
S:G$MbWrByte$0$0({2}DF,SC:U),C,0,0
S:G$MbWrWord$0$0({2}DF,SC:U),C,0,0
S:G$MbWrEoT$0$0({2}DF,SC:U),C,0,0
S:G$MbLrc$0$0({2}DF,SC:U),C,0,0
S:G$MbRd$0$0({2}DF,SC:U),C,0,0
S:G$MbWr$0$0({2}DF,SC:U),C,0,0
S:G$MbWrOne$0$0({2}DF,SC:U),C,0,0
S:G$MbAnsRd$0$0({2}DF,SC:U),C,0,0
S:G$MbAnsErr$0$0({2}DF,SC:U),C,0,0
...
S:G$ComInit$0$0({2}DF,SV:S),C,0,0
S:G$VarInit$0$0({2}DF,SV:S),C,0,0
S:G$SendBuf$0$0({2}DF,SV:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:Fmain$_str_0$0$0({30}DA30,SC:S),D,0,0
