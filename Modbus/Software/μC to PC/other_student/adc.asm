...
; This file was generated Mon Nov 23 17:14:07 2015
;--------------------------------------------------------
	.module adc
...
;------------------------------------------------------------
;channels                  Allocated to registers 
;------------------------------------------------------------
	G$AdcInit$0$0 ==.
	C$adc.c$5$0$0 ==.
;	adc.c:5: void AdcInit(byte channels)
;	-----------------------------------------
;	 function AdcInit
;	-----------------------------------------
_AdcInit:
...
;	adc.c:8: ADCLK=0x01;
	mov	_ADCLK,#0x01
	C$adc.c$9$1$1 ==.
;	adc.c:9: ADCON = MSK_ADCON_ADEN;
	mov	_ADCON,#0x20
	C$adc.c$10$1$1 ==.
	XG$AdcInit$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'AdcConv'
;------------------------------------------------------------
;channel                   Allocated to registers r2 
;------------------------------------------------------------
	G$AdcConv$0$0 ==.
	C$adc.c$12$1$1 ==.
;	adc.c:12: word AdcConv(byte channel)
;	-----------------------------------------
;	 function AdcConv
;	-----------------------------------------
_AdcConv:
	mov	r2,dpl
	C$adc.c$14$1$1 ==.
;	adc.c:14: ADCON &= ~MSK_ADCON_SCH;
	anl	_ADCON,#0xF8
	C$adc.c$15$1$1 ==.
;	adc.c:15: ADCON |= (channel & MSK_ADCON_SCH);
	mov	a,#0x07
	anl	a,r2
	orl	_ADCON,a
	C$adc.c$16$1$1 ==.
;	adc.c:16: ADCON |= MSK_ADCON_ADSST;                   /* Start conversion */
	orl	_ADCON,#0x08
	C$adc.c$17$1$1 ==.
;	adc.c:17: while((ADCON & MSK_ADCON_ADEOC)==0);
00101$:
	mov	a,_ADCON
	jnb	acc.4,00101$
	C$adc.c$18$1$1 ==.
;	adc.c:18: ADCON &= ~MSK_ADCON_ADEOC;
	anl	_ADCON,#0xEF
	C$adc.c$19$1$1 ==.
;	adc.c:19: return (ADDH <<2)+(ADDL & 3);
	mov	r2,_ADDH
	clr	a
	xch	a,r2
	add	a,acc
