...
F:G$timer1$0$0({2}DF,SV:S),C,0,0,1,1,0
S:G$stav$0$0({1}SC:U),E,0,0
S:G$cnt_ticks$0$0({1}SC:U),E,0,0
S:G$itx$0$0({2}SI:U),E,0,0
S:G$ix$0$0({2}SI:U),E,0,0
S:G$valWord$0$0({2}SI:U),E,0,0
S:G$val$0$0({2}SI:U),E,0,0
S:Lmain$byteIn$1$1({1}SC:S),R,0,0,[r2]
S:Lmain$kod_r$1$1({1}SC:S),R,0,0,[]
S:Lmain$pocet$1$1({1}SC:S),R,0,0,[]
S:Lmain$lrc$1$1({1}SC:U),R,0,0,[]
S:G$prep$0$0({1}SB0$1:U),H,0,0
S:G$bfin$0$0({256}DA256,SC:U),F,0,0
S:G$bfout$0$0({256}DA256,SC:U),F,0,0
...
S:G$LBanit$0$0({2}DF,SV:S),C,0,0
...
S:Fmain$_str_1$0$0({21}DA21,SC:S),D,0,0
