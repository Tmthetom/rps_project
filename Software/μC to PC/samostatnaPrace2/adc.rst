   ...
   02EA 22                  770 	ret
                    ...
                    000A    777 	C$adc.c$12$1$1 ==.
                            ...
                            781 ;	-----------------------------------------
   02EB                     782 _AdcConv:
   02EB AA 82               783 	mov	r2,dpl
                    000C    784 	C$adc.c$14$1$1 ==.
                            785 ;	adc.c:14: ADCON &= ~MSK_ADCON_SCH;
   02ED 53 F3 F8            786 	anl	_ADCON,#0xF8
                    000F    787 	C$adc.c$15$1$1 ==.
                            788 ;	adc.c:15: ADCON |= (channel & MSK_ADCON_SCH);
   02F0 74 07               789 	mov	a,#0x07
   02F2 5A                  790 	anl	a,r2
   02F3 42 F3               791 	orl	_ADCON,a
                    0014    792 	C$adc.c$16$1$1 ==.
                            793 ;	adc.c:16: ADCON |= MSK_ADCON_ADSST;                   /* Start conversion */
   02F5 43 F3 08            794 	orl	_ADCON,#0x08
                    0017    795 	C$adc.c$17$1$1 ==.
                            796 ;	adc.c:17: while((ADCON & MSK_ADCON_ADEOC)==0);
   02F8                     797 00101$:
   02F8 E5 F3               798 	mov	a,_ADCON
   02FA 30 E4 FB            799 	jnb	acc.4,00101$
                    001C    800 	C$adc.c$18$1$1 ==.
                            801 ;	adc.c:18: ADCON &= ~MSK_ADCON_ADEOC;
   02FD 53 F3 EF            802 	anl	_ADCON,#0xEF
                    001F    803 	C$adc.c$19$1$1 ==.
                            804 ;	adc.c:19: return (ADDH <<2)+(ADDL & 3);
   0300 AA F5               805 	mov	r2,_ADDH
   0302 E4                  806 	clr	a
   0303 CA                  807 	xch	a,r2
   0304 25 E0               808 	add	a,acc
   0306 CA                  809 	xch	a,r2
   0307 33                  810 	rlc	a
   0308 CA                  811 	xch	a,r2
   0309 25 E0               812 	add	a,acc
   030B CA                  813 	xch	a,r2
   030C 33                  814 	rlc	a
   030D FB                  815 	mov	r3,a
   030E 74 03               816 	mov	a,#0x03
   0310 55 F4               817 	anl	a,_ADDL
   0312 FC                  818 	mov	r4,a
   0313 7D 00               819 	mov	r5,#0x00
   0315 EC                  820 	mov	a,r4
   0316 2A                  821 	add	a,r2
   0317 F5 82               822 	mov	dpl,a
   0319 ED                  823 	mov	a,r5
   031A 3B                  824 	addc	a,r3
   031B F5 83               825 	mov	dph,a
