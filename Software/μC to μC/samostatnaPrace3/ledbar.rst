   ...
   0411 22                  805 	ret
                    ...
                    001F    813 	C$ledbar.c$33$1$1 ==.
                            ...
                            817 ;	-----------------------------------------
   0412                     818 _LedBar:
   0412 AA 82               819 	mov	r2,dpl
   0414 AB 83               820 	mov	r3,dph
                    0023    821 	C$ledbar.c$37$1$1 ==.
                            822 ;	ledbar.c:37: LB_MR=0;
   0416 C2 95               823 	clr	_P1_5
                    0025    824 	C$ledbar.c$38$1$1 ==.
                            825 ;	ledbar.c:38: LB_MR=1;
   0418 D2 95               826 	setb	_P1_5
                    0027    827 	C$ledbar.c$40$1$1 ==.
                            828 ;	ledbar.c:40: for(i=0;i<10;i++)
   041A 7C 00               829 	mov	r4,#0x00
   041C                     830 00101$:
   041C BC 0A 00            831 	cjne	r4,#0x0A,00110$
   041F                     832 00110$:
   041F 50 18               833 	jnc	00104$
                    002E    834 	C$ledbar.c$42$2$2 ==.
                            835 ;	ledbar.c:42: LB_DS=!(val & 0x200);
   0421 EB                  836 	mov	a,r3
   0422 03                  837 	rr	a
   0423 54 01               838 	anl	a,#0x01
   0425 FD                  839 	mov	r5,a
   0426 B4 01 00            840 	cjne	a,#0x01,00112$
   0429                     841 00112$:
   0429 92 93               842 	mov	_P1_3,c
                    0038    843 	C$ledbar.c$43$2$2 ==.
                            844 ;	ledbar.c:43: val <<= 1;
   042B EB                  845 	mov	a,r3
   042C CA                  846 	xch	a,r2
   042D 25 E0               847 	add	a,acc
   042F CA                  848 	xch	a,r2
   0430 33                  849 	rlc	a
   0431 FB                  850 	mov	r3,a
                    003F    851 	C$ledbar.c$44$2$2 ==.
                            852 ;	ledbar.c:44: LB_SH=1;
   0432 D2 94               853 	setb	_P1_4
                    0041    854 	C$ledbar.c$45$2$2 ==.
                            855 ;	ledbar.c:45: LB_SH=0;
   0434 C2 94               856 	clr	_P1_4
                    0043    857 	C$ledbar.c$40$1$1 ==.
                            858 ;	ledbar.c:40: for(i=0;i<10;i++)
   0436 0C                  859 	inc	r4
   0437 80 E3               860 	sjmp	00101$
   0439                     861 00104$:
                    0046    862 	C$ledbar.c$47$1$1 ==.
                            863 ;	ledbar.c:47: LB_ST=1;
   0439 D2 96               864 	setb	_P1_6
                    0048    865 	C$ledbar.c$48$1$1 ==.
                            866 ;	ledbar.c:48: LB_ST=0;
   043B C2 96               867 	clr	_P1_6
